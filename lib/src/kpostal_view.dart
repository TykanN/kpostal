...
import 'package:kpostal/src/webview/kpostal_webview.dart';
...
class KpostalView extends StatefulWidget {
  ...
  KpostalView({
    ...
    this.kakaoKey = '',
         ...
         1024 <= localPort && localPort <= 49151,
...
class _KpostalViewState extends State<KpostalView> {
  ...
  void initState() {
    ...
    targetUri = !kIsWeb && widget.useLocalServer
        ...
        // v1 사용자와 공유되는 kakao_postcode.html과 분리된 v2 전용 페이지입니다.
        : Uri.https(
            'tykann.github.io',
            '/kpostal/assets/kakao_postcode_v2.html',
            queryParams,
          );
  }
    ...
    return Scaffold(
      appBar:
          ...
          AppBar(
            ...
            iconTheme: Theme.of(
              context,
            ).iconTheme.copyWith(color: widget.titleColor),
          ),
      body: Stack(
        children: [
          KpostalWebView(
            targetUri: targetUri,
            useLocalServer: widget.useLocalServer,
